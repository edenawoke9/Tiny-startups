...
export default function LoginForm() {
  ...
  const handleSocialLogin = (provider: string) => {
    ...
    signIn(provider, { callbackUrl: "/about-you" });
  };
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-4xl">
        <div className="flex gap-2 w-full py-10">
          ...
          <div className="space-y-6 w-1/2 flex items-center ">
            <form onSubmit={handleSubmit} className="space-y-6 w-full">
              ...
              {submitStatus !== "idle" && (
                <Alert
                  className={`border-l-4 px-4 py-3 rounded-md ${
          ...
          {/* Divider */}
          <div className=" lg:flex flex-col items-center justify-center px-5">
            <div className="h-16 border-l border-gray-300" />
            <span className="text-sm text-gray-500 font-medium my-2">OR</span>
            <div className="h-16 border-l border-gray-300" />
          </div>
          ...
          <div className="space-y-4 w-1/2">
            {[
              ...
              <Button
                ...
                className="w-full h-12 justify-start gap-4 border border-gray-300 rounded-md hover:bg-gray-100 transition-colors"
              >
                {icon}
                {label}
              </Button>
        ...
        {/* Footer */}
        <div className="mt-6 sm:mt-8 lg:mt-12 text-center space-y-4">
